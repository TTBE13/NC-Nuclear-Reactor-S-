...
if e == 1:
	...
	while True:
		...
		if minpl == 'i':
			tipes = input("Выберете тип ЭС(b-сжигатель биотоплива, c-угольная ЭС, g-газовая ЭС, n-нефтяная ЭС)>>")
			...
			if tipes == 'g':
				...
				print("вы купили", kolvogas, "газовых ЭС, у вас", val, "денег и", kolvogas, "газовых ЭС")
				tipes = 'm'
				minpl = 'a'
			if tipes == 'n':
				kop = kolvoes * neftval
				...
				print("вы купили", kolvoneft, "нефтяных ЭС, у вас", val, "денег и", kolvoneft, "нефтяных ЭС")
				tipes = 'm'
				minpl = 'a'
		if minpl == 'u':
